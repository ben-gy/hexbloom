/**
 * storage.ts — namespaced, typed, quota-safe localStorage. Copied from the
 * gh-game-factory patterns/ engine. Local-only by design (never authoritative
 * across peers — that's the host's job).
 */
